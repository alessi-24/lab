...
#書き出し
path = "/Users/nishimurarei/research/result_try2/chi/chi_1/"
...
function making_data()
    ...
    chi_inv_Temp_noise = chi_inv_Temp + rand(rng, d_chi,n_chi)
...
function metropolis_chi(para_B20_ini, para_B40_ini, para_B44_ini, flag, ac_B20, ac_B40, ac_B44)
    ...
    para_B40_renew, ac_B40 = metropolis_chi_B40(para_B20_renew, para_B40_ini, para_B44_ini, flag, ac_B40)
    para_B44_renew, ac_B44 = metropolis_chi_B44(para_B20_renew, para_B40_renew, para_B44_ini, flag, ac_B44)
    ...
    for replica in 1:L-1
        ...
        prob = exp(
            n_chi * b_chi * beta_dif[replica] * (
                error_chi(para_B20[replica + 1], para_B40[replica + 1], para_B44[replica + 1]) - error_chi(para_B20[replica], para_B40[replica], para_B40[replica])
                )
            )
...
function initial_para_make()
    #パラメータ候補値
    para_num = collect(0.10:0.01:1.00)
